...
/// Usage:
/// - Instantiate BusinessAnalyticsWidget() inside your MyBusinessPage body.
...
class BusinessAnalyticsWidget extends StatefulWidget {
  ...
  const BusinessAnalyticsWidget({super.key, this.daysToShow = 14});
